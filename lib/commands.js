...
export function openTicket(commandData) {
  ...
  .then(ticket => {
    ...
    var text = '<' + slackCustomerUser + '> A <https://auth0.zendesk.com/agent/tickets/' + ticket.ticket.id + '|' + 'support ticket> has been opened for your request. We contact you through the email address associated with your Slack account as soon as possible.';
